...
public class Base {
    ...
    protected Animacion anim;    //animacion.
     ...
     */
    public void setAnimacion(Animacion anima) {
        this.anim = anima;
    }
    ...
    /**
     * Checa si el punto <code>int x, int y</code> intersecta la rectangulo del <code>Base</code>
     * @return un valor boleano <code>true</code> si lo intersecta <code>false</code>
     * en caso contrario
     * @param x
     * @param y
     */
    public boolean intersectaClick(int x, int y){
